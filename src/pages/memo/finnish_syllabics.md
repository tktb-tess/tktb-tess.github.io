...
オフグライドが <span class="font-ipa">/\_i̯/</span> のものは「ᔾ」を、<span class="font-ipa">/\_u̯/</span>, <span class="font-ipa">/\_y̯/</span> であるものは「ᕝ」を文字の右上に置く。  
<span class="font-ipa">/\_u̯/</span> と <span class="font-ipa">/\_y̯/</span> の区別は上に示したものと同様に母音調和記号で区別する。

また、opening二重母音 <span class="font-ipa">/ie̯/</span>, <span class="font-ipa">/uo̯/</span>, <span class="font-ipa">/yø̯/</span> はそれぞれ Ce と Co の文字の右上に「ᐦ」（U\+1426）を置いて表す。
