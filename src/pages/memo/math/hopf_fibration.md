...
\mapsto\left\lbrace
\begin{aligned}
\frac{1}{|z|^2 + 1} &(2\operatorname{Re}{z},\ 2\operatorname{Im}{z},\ |z|^2 - 1) & &(z \neq \infty) \\ \\
&(0, 0, 1) & &(z = \infty)
\end{aligned}
\right.
```

$z$ に $z_0 / z_1$ を代入すると、 $|z_0|^2 + |z_1|^2 = 1$ を用いて、
...
\begin{alignedat}{1}
\frac{z_0}{z_1}
&\mapsto \frac{1}{|z_0 / z_1|^2 + 1} \left( 2\operatorname{Re}{\frac{z_0}{z_1}}, 2\operatorname{Im}{\frac{z_0}{z_1}}, \left| \frac{z_0}{z_1} \right|^2 - 1 \right) \\ \\
&= \frac{1}{|z_0|^2 + |z_1|^2} \left( 2\operatorname{Re}{\left( |z_1|^2 \cdot \frac{z_0}{z_1} \right)}, 2\operatorname{Im}{\left( |z_1|^2 \cdot \frac{z_0}{z_1} \right)}, |z_0|^2 - |z_1|^2 \right) \\ \\
&= \left( 2\operatorname{Re}{\left( z_1 z_1^{*} \cdot \frac{z_0}{z_1} \right)}, 2\operatorname{Im}{\left( z_1 z_1^{*} \cdot \frac{z_0}{z_1} \right)}, |z_0|^2 - |z_1|^2 \right) \\ \\
&= \left( 2\operatorname{Re}{z_0 z_1^{*}},\ 2\operatorname{Im}{z_0 z_1^{*}},\ |z_0|^2 - |z_1|^2 \right)
\end{alignedat}
```
...
```math
(z_0, z_1) \mapsto \left( 2\text{Re}\ z_0 z_1^{*},\ 2\text{Im} z_0 z_1^{*},\ |z_0|^2 - |z_1|^2 \right)
```
...
&= x_0 x_1 + y_0 y_1 + i(y_0 x_1 - x_0y_1) \\
\\
...
```math
(x_0, y_0, x_1, y_1) \mapsto \left( 2(x_0 x_1 + y_0 y_1),\ 2(y_0 x_1 - x_0 y_1),\ x_0^2 + y_0^2 - x_1^2 - y_1^2 \right)
```
