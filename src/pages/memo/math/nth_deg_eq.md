...
$c_0, c_1$ は実数とし $D > 0$ とする。またこのとき $c_1 < 0$ である。なぜならば $c_1 \ge 0$ であれば $D = -4c_1^3 - 27c_0^2 \le 0$ となるため。
...
ここで、左辺が (2乗) - (2乗) の形になれば、左辺は2つの2次式に因数分解出来て2次方程式に帰着できる。よって第2項 $(2\mu - c_2)t^2 - c_1 t + \mu^2 - c_0$ が完全平方になるように $\mu$ の値を決める。これは2次方程式 $(2\mu - c_2)t^2 - c_1 t + \mu^2 - c_0 = 0$ が重解をもつこと、またその判別式が0であることと同値。判別式 $D$ は
...
これの第2項が完全平方になればよい。$t$ についての2次方程式 $(2\mu + 24)t^2 + 28t + \mu^2 + 3 = 0$ の判別式を $D$ とおくと

$$
\begin{alignedat}{2}
D &= 14^2 - (2\mu + 24)(\mu^2 + 3) \\
